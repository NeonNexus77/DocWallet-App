                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        ...
                        if (selectedFiles != null) {
                          safeSetState(() =>
                              _model.isDataUploading_uploadDataYd5 = true);
                          ...
                          try {
                            ...
                            _model.isDataUploading_uploadDataYd5 = false;
                          }
                          if (selectedUploadedFiles.length ==
                                  selectedFiles.length &&
                              downloadUrls.length == selectedFiles.length) {
                            safeSetState(() {
                              _model.uploadedLocalFile_uploadDataYd5 =
                                  selectedUploadedFiles.first;
                              _model.uploadedFileUrl_uploadDataYd5 =
                                  downloadUrls.first;
                            });
                          } else {
                            safeSetState(() {});
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                            ...
                            if ((_model.uploadedLocalFile_uploadDataYd5.bytes
                                        ?.isNotEmpty ??
                                    false))
                              Align(
                  ...
                  child: Align(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        unawaited(
                          () async {
                            await FrontDocTable().insert({
                              'user_id': FFAppState().userid,
                              'file_url': _model.uploadedFileUrl_uploadDataYd5,
                              'file_name': widget.documentName,
                            });
                          }(),
                        );
