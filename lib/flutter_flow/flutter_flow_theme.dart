...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF6B19DB);
  late Color secondary = const Color(0xFF367BFF);
  late Color tertiary = const Color(0xFFFFB830);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF19A1DB);
  late Color secondary = const Color(0xFFFF36B8);
  late Color tertiary = const Color(0xFFD330FF);
  late Color alternate = const Color(0xFF3B2B36);
  late Color primaryText = const Color(0xFF36E3FF);
  late Color secondaryText = const Color(0xFDF4F4F2);
  late Color primaryBackground = const Color(0xFF171B14);
  late Color secondaryBackground = const Color(0xFF1D2529);
  late Color accent1 = const Color(0x4CBF19DB);
  late Color accent2 = const Color(0x4D366DFF);
  late Color accent3 = const Color(0x4CFFA130);
  late Color accent4 = const Color(0xB214181B);
  late Color success = const Color(0xFF16B056);
  late Color warning = const Color(0xFFCC8E30);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);
}
