...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: FilePageWidget.routeName,
          path: FilePageWidget.routePath,
          requireAuth: true,
          builder: (context, params) => FilePageWidget(
        ...
        FFRoute(
          name: FamilyAcessPageWidget.routeName,
          path: FamilyAcessPageWidget.routePath,
          builder: (context, params) => FamilyAcessPageWidget(),
        )
