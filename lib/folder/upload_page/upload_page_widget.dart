                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        final selectedFiles = await selectFiles(
                          storageFolderPath: 'files',
                          multiFile: false,
                        );
                        if (selectedFiles != null) {
                          safeSetState(() =>
                              _model.isDataUploading_uploadDataYd2 = true);
                          ...
                          try {
                            ...
                            _model.isDataUploading_uploadDataYd2 = false;
                          }
                          if (selectedUploadedFiles.length ==
                                  selectedFiles.length &&
                              downloadUrls.length == selectedFiles.length) {
                            safeSetState(() {
                              _model.uploadedLocalFile_uploadDataYd2 =
                                  selectedUploadedFiles.first;
                              _model.uploadedFileUrl_uploadDataYd2 =
                                  downloadUrls.first;
                            });
                          } else {
                            safeSetState(() {});
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                            ...
                            if ((_model.uploadedLocalFile_uploadDataYd2.bytes
                                        ?.isNotEmpty ??
                                    false))
                              Align(
                                alignment: AlignmentDirectional(0.0, -8.38),
                                child: ClipRRect(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await DocumentTable().insert({
                          'file_name': _model.fileNameTextController.text,
                          'user_id': FFAppState().userid,
                          'folder_id': widget.folderid,
                          'file_url': _model.uploadedFileUrl_uploadDataYd2,
                        });
                        context.safePop();
                      },
                      text: 'Save',
